...
fn apply_build_cmd(root: Entity, talk_builder: TalkBuilder, world: &mut World) -> Vec<Entity> {
    let mut parent = root;
...
struct BuildNode {
    ...
    choices: Vec<(String, TalkBuilder)>,
}
